...
Unduh dan ekstrak [NVIDIA driver versi 536.40](https://www.nvidia.com/download/driverResults.aspx/209161/en-us/) (menggunakan 7-Zip atau WinRAR). Kemudian unduh berkas [yang sudah di-*patch*](https://github.com/dartraiden/NVIDIA-patcher/releases/download/536.40/536.40.zip) lalu ekstrak semua berkas dan folder dalam satu folder di mana berkas `setup.exe` berada.

Install berkas sertifikat `EVRootCA.crt` ke *Trusted Root Certification Authorities Certificate Store* dengan cara seperti berikut ini:

[![Instalasi certificate ke Trusted Root Certificare Authorities Certificate Store](/images/2023/posts/P106-100/certificate_install.webp)](images/2023/posts/P106-100/certificate_install.webp)
...
Driver yang sudah di-*patch* bisa dipasang dengan cara pergi ke `Device Manager`, lalu cari dan klik kanan pada item `3D video controller`, pilih `Properties`, pergi ke tab Driver kemudian pilih `Update driver`. Selanjutnya ikuti langkah berikut ini:
